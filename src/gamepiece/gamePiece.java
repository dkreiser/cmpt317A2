...
public abstract class gamePiece {
	 ...
	 * K for King G for Guard D for Dragon
	 */
	char myLetter;
	...
	/**
	 * change our current positional coordinates to a new set of coordinates and
	 * update the game board appropriately. Note: we don't have to do error
	 * testing here because it will be impossible for the player(s) to enter a
	 * position that is invalid based on the structure of the rest of our
	 * program.
	 * 
	 * @param newPosition
	 ...
	 *            the position we are checking against our own.
